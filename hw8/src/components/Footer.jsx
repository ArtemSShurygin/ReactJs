...
const Footer = () => {
  return(
    ...
    <div className="footer__footer__background_color">
      <div className="footer____footer__content container">
        <div>
          <p>© 2022 Brand All Rights Reserved.</p>
        </div>
        <nav className="footer____footer__nav">
          <div className="footer____footer__nav__icon">
